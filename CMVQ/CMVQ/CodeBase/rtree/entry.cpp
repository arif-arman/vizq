...
bool Entry::intersectsMBR(float *mbr)
{
	bool inside;
	bool overlap;
...
//Added by RAKIN for some reason rectangle class is behaving unusually cant use it anywhere
/*SomeRandomRectangle Entry::getRandomRectFromEntry(){
	Coordinate a(bounces[0], bounces[3]);
	Coordinate b(bounces[1], bounces[2]);

	SomeRandomRectangle rect(a, b);
