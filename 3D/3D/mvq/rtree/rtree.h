...
class QueryPoint
{
    public:  
     ...
     // list <Rectangle> ObstacleList; 
	  ...
	  void update_visibliliyRegion(Rectangle obstacle, Rectangle target);//IsInVisibleRegion true hole oi obstacle er jonno update korte hobe
	  double visibiliy(Rectangle Target);
      
	  double init_visibility(Rectangle Target);//jokhon kono obstacle nai consider kore
